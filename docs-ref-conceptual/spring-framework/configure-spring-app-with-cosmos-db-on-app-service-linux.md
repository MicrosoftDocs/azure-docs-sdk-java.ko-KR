...
- [App Service Linux 개발자 가이드의 Java](https://docs.microsoft.com/en-us/azure/app-service/containers/app-service-linux-java)
- [Java 개발자를 위한 Azure](https://docs.microsoft.com/en-us/java/azure/) Spring 및 Azure에 대해 자세히 알아보려면 Azure 설명서 센터의 Spring을 계속합니다.
