...
| | | | |
|:-------------:|:----------:|:----:|:---:|
| [Azure 저장소](#azure-storage) | [SQL 데이터베이스](#sql-database)  | [Redis Cache](#redis-cache)   | [DocumentDB](#documentdb) |
| [서비스 버스](#servicebus)  | [Azure Active Directory](#azuread) | [키 자격 증명 모음](#keyvault)  | [이벤트 허브](#eventhub)
| [IoT 서비스](#iotservice) | [IoT 장치](#iotdevice) | [Data Lake](#datalake)  | [AppInsights](#appinsights) | 
| [배치](#batch) | [Azure 리소스 관리](#management) |
...
### <a name="azure-storageazurestoragestorage-introduction"></a>[Azure 저장소](/azure/storage/storage-introduction)  
...
### <a name="sql-databaseazuresql-databasesql-database-technical-overview"></a>[SQL 데이터베이스](/azure/sql-database/sql-database-technical-overview)
...
[샘플](/azure/documentdb/documentdb-java-application) | [참조](http://azure.github.io/azure-documentdb-java/) | [GitHub](https://github.com/Azure/azure-documentdb-java)   | [릴리스 정보](https://github.com/Azure/azure-documentdb-java/blob/master/changelog.md)
...
### <a name="key-vaultazurekey-vault"></a>[키 자격 증명 모음](/azure/key-vault) 
...
### <a name="batchazurebatch"></a>[배치](/azure/batch)
